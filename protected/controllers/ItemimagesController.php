...
class ItemimagesController extends Controller
{
	...
	public function accessRules()
	{
        ...
        public function actionjsondata($id) {
                $data = Itemimages::model()->findByPk($id);
	...
	public function actionIndex()
	{
                ...
                $sql = "SELECT * FROM itemimages WHERE online = 1 $searchtxt ORDER BY name ASC ";                
	...
	{
		$model=new Itemimages('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Itemimages']))
			$model->attributes=$_GET['Itemimages'];
	...
	{
		$model=Itemimages::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Itemimages $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='itemimages-form')
		{
